...
class Profile_model extends CI_Model
{
	...
	function count_inbox($table)
	{
		$this->db->where('kontak_read', false);
		$this->db->from($table);
		return $this->db->count_all_results();
	}

	function count_inbox_distributor($table)
	{
		$this->db->where('pesan_read', false);
		$this->db->from($table);
		return $this->db->count_all_results();
	}
	...
	function count_testimony($table)
	{
		$this->db->from($table);
		return $this->db->count_all_results();
	}
