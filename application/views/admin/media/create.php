  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card card-user">
        ...
        <div class="card-body">
          <form class="form-horizontal" action="<?php echo base_url()?>index.php/admin/media/create/do_create" method="post" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="form-group">
                  <select class="form-control" id="kategori" name="media_med_kat_id" required>
                    ...
                    <?php foreach ($kategori as $key): ?>
                      <option value="<?php echo $key->med_kat_id?>"><?php echo $key->med_kat_name?></option>
                    <?php endforeach ?>
                  </select>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-10">
                <div class="form-group">
                  <textarea id="editor1" rows="10" cols="80" name="media_isi"></textarea>
                </div>
              </div>
            </div>
            <div class="row">
