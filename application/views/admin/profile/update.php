      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="pemesanan_kode" name="name" value="<?php echo $key->name?>">
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            <label for="mitra_telepon" class=" control-label">Username</label>
            <input type="text" class="form-control" id="mitra_telepon" name="usersname" value="<?php echo $key->users_username?>">
          </div>
        </div>
      </div>
    </div>
