      ...
      <div class="card">
        ...
        <div class="toolbar">
          ...
          <div class="alert alert-info">
            <b>Kumpulan data pengeluaran keuangan sekolah</b>
          </div>
          <div class="">
            <div class="row">
...
$('#result').html('<h2>Loading....</h2>');
  $.ajax({
    url:"<?php echo base_url()?>index.php/finance/finance/list_data_kredit",
...
$('#cari').click(function(){
  ...
  $.ajax({
    type:"POST",
    url:"<?php echo base_url()?>index.php/finance/finance/list_data_kredit/search",
    type:"get",
