  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <div class="toolbar">
            <a href="<?php echo base_url()?>index.php/finance/finance/kredit"><button class="btn btn-success"><i class="fa fa-arrow-left"></i> &nbsp; Kembali </button></a>
          </div>
          <form class="register-form" action="<?php echo base_url()?>index.php/finance/finance/kredit_create/do_create" method="post" id="sppForm">
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group">
                  <label>Approval Code</label> <font color="red">*</font>
                  <input type="text" placeholder="Masukkan kode penerimaan kredit" class="form-control" name="approval_code" id="approval_code" required>
                  <font color="red" id='notif'></font>
                </div>
                <div class="form-group">
                  <label>Deskripsi/Keterangan</label> <font color="red">*</font>
                  <input type="text" placeholder="Masukkan keterangan kredit" class="form-control" name="description" required>
                </div>
                <div class="form-group">
