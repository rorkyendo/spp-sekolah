   ...
   <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">List Laporan keuangan sekolah</h4>
        </div>
        <div class="card-body">
        <div class="toolbar">
            <a href="<?php echo base_url()?>index.php/finance/finance/kredit_create"><button class="btn btn-success"><i class="fa fa-plus"></i> &nbsp; Tambah Data Baru</button></a>
          </div>
          <?php echo $this->session->flashdata('notif');?>
          <div class="alert alert-info">
            <b>Kumpulan data laporan keuangan sekolah</b>
          </div>
          <div class="">
            <div class="row">
...
$('#result').html('<h2>Loading....</h2>');
  $.ajax({
    url:"<?php echo base_url()?>index.php/finance/finance/list_data_report",
...
$('#cari').click(function(){
  ...
  $.ajax({
    type:"POST",
    url:"<?php echo base_url()?>index.php/finance/finance/list_data_report/search",
    type:"get",
...
Swal(
  ...
  'success',
  $.ajax({
    url:"<?php echo base_url()?>index.php/finance/finance/kredit_delete/"+id,
    success:function(){
      location.reload();
    }
  })
