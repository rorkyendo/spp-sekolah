...
<div class="modal-content">
  <div class="modal-header justify-content-center">
    ...
    <h4 class="title title-up">Detail Siswa</h4>
  </div>
  <div class="modal-body">
    <div class="row">
      ...
      <div class="col-sm-6">
        <div class="form-group">
          <label for="pegawai_name" class=" control-label">NISN</label>
          <input type="text" class="form-control" id="pegawai_name" value="<?php echo $key->nisn?>" readonly>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="pegawai_username" class=" control-label">Nama Orangtua/Wali</label>
          <input type="text" class="form-control" id="pegawai_username" value="<?php echo $key->parent_name?>" readonly>
        </div>
        <div class="form-group">
          <label for="pegawai_username" class=" control-label">Tahun Masuk/Pendaftaran</label>
          <input type="text" class="form-control" id="pegawai_username" value="<?php echo $key->register_year?>" readonly>
        </div>
        </div>
        <div class="col-sm-6">
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="pegawai_username" class=" control-label">Kelas</label>
          <input type="text" class="form-control" id="pegawai_username" value="<?php echo $key->class?>" readonly>
        </div>
        <div class="form-group">
