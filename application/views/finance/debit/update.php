...
<div class="modal-content">
  <form id="updateForm" action="<?php echo base_url()?>index.php/finance/finance/debit_update/<?php echo $key->id_finance?>/do_update" method="post">
    <div class="modal-header justify-content-center">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <i class="nc-icon nc-simple-remove"></i>
      </button>
      <h4 class="title title-up">Update Debit</h4>
    </div>
      ...
      <div class="row">
          <div class="col-lg-12">
            <div class="form-group">
              ...
              <input type="text" placeholder="Masukkan keterangan debit" value="<?php echo $key->description?>" class="form-control" name="description" required>
            </div>
            <div class="form-group">
