   ...
   <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">List SPP</h4>
        </div>
        <div class="card-body">
        <div class="toolbar">
            <a href="<?php echo base_url()?>index.php/finance/finance/school_fees_create"><button class="btn btn-success"><i class="fa fa-plus"></i> &nbsp; Tambah Data Baru</button></a>
          </div>
          <?php echo $this->session->flashdata('notif');?>
          <div class="alert alert-info">
            <b>Data yang ada didalam list hanya data yang sudah membayar uang sekolah</b>
          </div>
          <div class="">
            <div class="row">
...
$('#result').html('<h2>Loading....</h2>');
  $.ajax({
    url:"<?php echo base_url()?>index.php/finance/finance/list_data_school_fees",
...
$('#cari').click(function(){
  ...
  $.ajax({
    type:"POST",
    url:"<?php echo base_url()?>index.php/finance/finance/list_data_school_fees/search",
    type:"get",
    data:"start_date="+_start_date+"&end_date="+_end_date+"&major="+_major+"&class="+_class,
    success:function(data){
      $('#result').html(data);
    }
  });
...
Swal(
  ...
  'success',
  $.ajax({
    url:"<?php echo base_url()?>index.php/finance/finance/spp_delete/"+id,
    success:function(){
      location.reload();
    }
  })
